...
export const PAGE_ACCESS = Object.freeze({
  ...
  newsroom: {
    console: 'platform',
    roles: ['super_admin', 'platform_admin', 'reporter'],
  ...
  analytics: {
    console: 'platform',
    roles: ['super_admin', 'platform_admin', 'finance_admin', 'moderator'],
  ...
  'community-manager': {
    console: 'workspace',
    roles: ['community_host', 'verified_operator', 'tournament_host', 'venue_partner', 'academy_operator', 'coach_operator'],
    permissions: [APP_PERMISSIONS.TOURNAMENT_CREATE, APP_PERMISSIONS.TOURNAMENT_EDIT],
  },
  'sponsor-manager': {
    console: 'workspace',
    roles: ['verified_operator', 'tournament_host', 'venue_partner', 'sponsor_partner', 'federation_operator'],
    permissions: [APP_PERMISSIONS.TOURNAMENT_SPONSORSHIP_MANAGE],
  },
  'tournament-manager': {
    console: 'workspace',
    roles: ['verified_operator', 'tournament_host', 'venue_partner', 'federation_operator', 'verification_admin', 'finance_admin'],
    permissions: [
  ...
  'training-manager': {
    console: 'workspace',
    roles: ['community_host', 'academy_operator', 'coach_operator', 'verified_operator', 'tournament_host', 'venue_partner'],
    permissions: [APP_PERMISSIONS.TOURNAMENT_CREATE, APP_PERMISSIONS.TOURNAMENT_EDIT],
  },
  'venue-manager': {
    console: 'workspace',
    roles: ['verified_operator', 'tournament_host', 'venue_partner', 'federation_operator', 'venue_owner', 'venue_manager', 'venue_officer'],
    permissions: [APP_PERMISSIONS.TOURNAMENT_CREATE, APP_PERMISSIONS.TOURNAMENT_EDIT],
  },
  'venue-workspace': {
    console: 'workspace',
  ...
  'venue-dashboard': {
    console: 'workspace',
    roles: ['verified_operator', 'tournament_host', 'venue_partner', 'federation_operator', 'venue_owner', 'venue_manager', 'venue_staff', 'venue_officer'],
  },
  'venue-courts': {
    console: 'workspace',
    roles: ['verified_operator', 'tournament_host', 'venue_partner', 'federation_operator', 'venue_owner', 'venue_manager', 'venue_staff', 'venue_officer'],
  ...
  'venue-pos': {
    console: 'workspace',
    roles: ['verified_operator', 'tournament_host', 'venue_partner', 'venue_owner', 'venue_manager', 'cashier'],
  },
  'venue-membership': {
    console: 'workspace',
    roles: ['verified_operator', 'tournament_host', 'venue_partner', 'venue_owner', 'venue_manager'],
  },
  'venue-customers': {
    console: 'workspace',
    roles: ['verified_operator', 'tournament_host', 'venue_partner', 'venue_owner', 'venue_manager', 'cashier'],
  ...
  'venue-maintenance': {
    console: 'workspace',
    roles: ['verified_operator', 'tournament_host', 'venue_partner', 'venue_owner', 'venue_manager', 'venue_staff', 'venue_officer'],
  },
  'venue-ads': {
    console: 'workspace',
    roles: ['verified_operator', 'tournament_host', 'venue_partner', 'sponsor_partner', 'venue_owner', 'venue_manager'],
  },
  'venue-finance': {
    console: 'workspace',
    roles: ['verified_operator', 'tournament_host', 'venue_partner', 'venue_owner', 'venue_manager'],
  ...
  'venue-settings': {
    console: 'workspace',
    roles: ['verified_operator', 'tournament_host', 'venue_partner', 'venue_owner'],
  },
  'official-center': { console: 'official' },
  'official-schedule': { console: 'official' },
  'match-center': { console: 'official', roles: ['match_official', 'referee', 'assistant_referee', 'timekeeper', 'match_commissioner', 'statistic_operator', 'lineup_operator'] },
  'match-report': { console: 'official', roles: ['match_official', 'referee', 'assistant_referee', 'match_commissioner', 'lineup_operator'] },
  'match-statistics': { console: 'official', roles: ['match_official', 'referee', 'assistant_referee', 'timekeeper', 'match_commissioner', 'statistic_operator', 'lineup_operator'] },
});
